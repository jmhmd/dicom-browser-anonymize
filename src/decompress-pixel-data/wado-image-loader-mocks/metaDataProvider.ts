...
export default function createMetaDataProvider(cornerstoneWADOImageLoader: any) {
  return function metaDataProvider(type: string, imageId: string) {
    const {
      getNumberValues,
      getImagePixelModule,
    ...
    } = cornerstoneWADOImageLoader.wadouri.metaData;

    // const parsedImageId = parseImageId(imageId);
    const parsedImageId = { url: imageId, frame: null };
